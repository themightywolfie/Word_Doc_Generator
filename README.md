...
5. If you are using the exe file, anti-virus softwares will try to block it as I created it using PyInstaller which created unsigned binary files. DONT WORRY, you can still use it safely if you allow the file to execute
